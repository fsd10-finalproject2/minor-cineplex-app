...
const { isSavingCoupon, isGetCoupon, onGetCouponClick } = useCouponClaim({
...
<template>
  <Teleport to="body">
    <Transition name="coupon-code-modal" @after-leave="emit('afterLeave')">
      <div
        v-if="modelValue"
        class="coupon-code-modal-root fixed inset-0 flex items-center justify-center pt-6 lg:p-4"
        :class="isLoginModalOpen ? 'z-40' : 'z-100'"
      >
          ...
          <div ref="modalPanelRef"
            ...
            <header
              ...
              <button type="button"
                ...
                aria-label="Close dialog" @click="closeModal">
        ...
        <UIModal v-model="isLoginModalOpen" size="lg" title="" class="flex justify-center items-center">
          <div class="flex w-full flex-col items-center justify-center py-auto min-h-[min(70vh,28rem)]">
