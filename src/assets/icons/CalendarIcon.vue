...
<template>
  <svg :width="props.size" :height="props.size" viewBox="0 0 24 24" fill="none" v-bind="$attrs">
    <rect x="3" y="6" width="18" height="15" rx="2" :stroke="props.color" stroke-width="1.5" />
    <path
      ...
      :fill="props.color"
    />
    <path d="M7 3L7 6" :stroke="props.color" stroke-width="1" stroke-linecap="round" />
    <path d="M17 3L17 6" :stroke="props.color" stroke-width="1" stroke-linecap="round" />
  </svg>
</template>
